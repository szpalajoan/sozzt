...
trait FileSample implements ContractSample, PreliminaryPlanSample, RoutePreparationSample, PlotOwnerConsentSample {
    ...
    PreparedFile KRYNICA_PRIVATE_PLOT_OWNER_CONSENT_AGREEMENT = new PreparedFile(KRYNICA_PRIVATE_PLOT_OWNER_CONSENT_AGREEMENT_METADATA, KRYNICA_PRIVATE_PLOT_OWNER_CONSENT_AGREEMENT_FILE)
    PreparedFile KRYNICA_PUBLIC_OWNER_CONSENT_AGREEMENT = new PreparedFile(KRYNICA_PUBLIC_OWNER_CONSENT_AGREEMENT_METADATA, KRYNICA_PUBLIC_OWNER_CONSENT_AGREEMENT_FILE)
