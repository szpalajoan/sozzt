...
class CompleteRoutePreparationSpec extends SozztSpecification {
    ...
    def "should complete route preparation and begin preparation of documentation when consents step is completed"() {
        ...
        and: "Consents collection is completed"
        ...
        then: "Route preparation is completed"
            contractFacade.getContract(KRYNICA_CONTRACT.contractId) == COMPLETED_ROUTE_PREPARATION_KRYNICA_CONTRACT_WITH_COMPLETED_CONSENTS
    }
